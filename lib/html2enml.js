...
(function() {
  var DOMParser, Evernote, XMLHttpRequest, XMLSerializer, _adjustUrl, _convertMedia, _convertNodes, async, base1, enmlProhibitedAttributes, enmlProhibitedTags, htmlToEnml, md5, parser, ref, requests, resources, serializer,
  ...
  _convertMedia = function(element, url, callback) {
    ...
    request.onload = function(e) {
      var hash, i, j, len, mime, resource, response, str;
      response = e.target;
