...
(function() {
  var DOMParser, XMLHttpRequest, XMLSerializer, _adjustUrl, _convertMedia, _convertNodes, async, enmlProhibitedAttributes, enmlProhibitedTags, htmlToEnml, md5, parser, ref, requests, serializer,
  ...
  _convertMedia = function(element, url, callback) {
    var request;
    console.log('CONVERT MEDIA 0');
    request = new XMLHttpRequest;
    request.element = element;
    request.open('GET', url, true);
    request.onload = function(e) {
      var hash, i, j, len, response, str;
      response = e.target;
